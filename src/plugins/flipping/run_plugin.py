"""
This script is called by the plugin-wrapper, flipping.js, which passes down the
...
plugin = flipping(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
